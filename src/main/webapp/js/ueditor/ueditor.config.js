...
//    var qiniuUrl="http://kry-test-2.qiniudn.com/";
    /**
...
//        ,getMovieUrl:URL+"jsp/getMovie.jsp"                   //视频数据获取地址
        ...
        , toolbars:[
            ['fullscreen','|', 'undo', 'redo', '|',
                ...
                'insertimage', /*'source','emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', 'background', */'|',
