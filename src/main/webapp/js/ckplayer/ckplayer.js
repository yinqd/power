    ...
    var ck = {
		...
		*/
		...
		以上是前7个参数的作用
			...
			{font color="#FFFFFF" size="12"}广告什么的最讨厌了{/font}
		*/
        advmarquee: escape(''),
        /*
...
(function() {
    var CKobject = {
		...
		_I_: null,
		_O_: {},
		uaMatch:function(u,rMsie,rFirefox,rOpera,rChrome,rSafari,rSafari2){
		...
		browser: function() {
			...
			var v;
			var c = u.toLowerCase();
			var d = this.uaMatch(c,rMsie,rFirefox,rOpera,rChrome,rSafari,rSafari2);
			if (d.b) {
				b = d.b;
				v = d.v;
			}
