...
function loadData(){
  ...
  //如果没选,就加全部
    ...
    $.ajax({
        type: "POST",
        url: ctxPath + "dlscz/queryDlsczYearReport.action",
        data: queryParameter,
        dataType: "json",
        ...
        success: function(data){
            ...
            if(items.length != 0){
            	for(var i=0;i<items.length;i++){
            	 ...
            	 dlscztotal = "<tr><td align='center' colspan='2'>总计：</td><td colspan='1' align='center'>" + data.yearTotal.rechargeCount + "</td><td colspan='1' align='center'>" + data.yearTotal.rechargePrice + "</td></tr>";
