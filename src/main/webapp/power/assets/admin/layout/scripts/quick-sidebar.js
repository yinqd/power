...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "张博士", 'avatar3', text);
            message = $(message);
            ...
            setTimeout(function(){
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "李教授", 'avatar2', '有事不在,请留言...');
                message = $(message);
                chatContainer.append(message);
