...
<link rel="stylesheet" href="<%=basePath %>/js/mCustomScrollbar/jquery.mCustomScrollbar.css?v1.0"/>
...
<!-- jgGrid start -->
<link rel="stylesheet" href="<%=basePath %>/js/plugins/jqGrid/jqGrid-4.4.3/css/ui.jqgrid.css?v1.0"/>
<link rel="stylesheet" href="<%=basePath %>/themes/style/css/plugins/jqGrid/jqGrid-4.4.3/resetJqGrid.css?v1.0"/>
<!-- jgGrid end -->
<!--[if IE]>
    <link rel="stylesheet" href="${ctxPath }/themes/style/css/ie.css"/>
<![endif]-->
...
<script src="<%=basePath %>/js/mCustomScrollbar/jquery.mCustomScrollbar.js?v1.0"></script>
...
<script src="<%=basePath %>/js/netUtil.js?v1.0"></script>
<title>代理商充值明细报表</title>
</head>
...
<script src="<%=basePath %>/js/terminaldlscz/dlsczdetail.js"></script>
